...
DEBUG = 'RENDER' not in os.environ # Automatically False on Render, True locally
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # CORS Middleware should be at the top to ensure it runs before other middleware
